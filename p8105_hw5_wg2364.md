...
two sets will be narrower. Also, we notice that the total mean is
approximately equal to the true *mu*. Again, this is result from CLT and
as the *mu* increase, the distribution of sample mean will follows a
normal distribution with increasing *mu* and the proportion of rejection
(H\_0: *mu* = 0) will get bigger.
